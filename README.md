...
Feel free to contribute, comment or report issues at https://github.com/Centaurioun/SwiftDefaultApps.

## Building from Source

This project has been modernized to use Swift Package Manager (SPM).

### Prerequisites
- macOS 10.13 or later
- Xcode 13 or later (for Swift 5.5+)
...
2. Run the build script:
   ...
   ./build.sh
   ```
3. The built artifacts will be in the `Build/` directory:
   - `SwiftDefaultApps.prefpane`
   - `DummyApp.app`

### Project Structure

- `Sources/SWDA-Prefpane`: The main Preference Pane logic and UI.
- `Sources/SWDA-CLI`: The command-line interface tool (`swda`).
- `Sources/DummyApp`: A helper application that does nothing (used for unassigning defaults).
- `Sources/SWDA-Common`: Shared code between targets.

## Installing & Uninstalling

* Download latest release from https://github.com/Centaurioun/SwiftDefaultApps/releases
...
```bash
appDir="/Library/PreferencePanes/SwiftDefaultApps.prefPane/Contents/Resources/DummyApp.app"
