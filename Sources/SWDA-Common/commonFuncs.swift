...
*/
public func convertAppURLsToPaths (_ inArray:Array<URL>?) -> Array<String>? {
...
*/
public func copyDictionaryAsString (_ inDict: [(key:String, value:String)]?) -> String? {
	var output = ""
	if let temp = inDict {
...
*/
public func copyStringArrayAsString (_ inArray: Array<String>?, separator: String = "\n") -> String? {
	if let temp = inArray {
...
extension DispatchQueue {
	public static let labelPrefix = "io.zamzam.ZamzamKit"
...
*/
public func displayAlert(error: OSStatus = Int32.min, arg1: String?, arg2: String?) throws {
